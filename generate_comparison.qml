...
Window {
    ...
    property real bloomStrengthParam: 0.1
    ...
    Timer {
        ...
        onTriggered: {
            root.contentItem.grabToImage(function(result) {
                result.saveToFile("/home/a.key/.gemini/antigravity-cli/brain/a7c0cf4d-d517-4eaf-a857-64318c074c1d/real_gpu_bloom_" + root.bloomSizeParam + "_strength_" + root.bloomStrengthParam + ".png");
                Qt.quit();
            });
        }
    }
